export const content = {
  en: {
    ...
    experience: [
      {
        ...
        bullets: [
          ...
          'Integrated dynamic content to keep the information published on the platform up to date.',
    ...
    education: {
      degree:
        "Bachelor's Degree in Business Computing (Information Systems)",
    ...
    experience: [
      {
        ...
        bullets: [
          ...
          'Integración de contenido dinámico para mantener actualizada la información publicada en la plataforma.',
...
export const ui = {
  en: {
    ...
    contact: {
      ...
      text:
        "I'm currently available for frontend opportunities and freelance projects. Write to me and let's talk about your idea.",
  ...
  es: {
    ...
    contact: {
      ...
      text:
        'Actualmente disponible para oportunidades frontend y proyectos freelance. Escríbeme y conversemos sobre tu idea.',
    },
  },
};